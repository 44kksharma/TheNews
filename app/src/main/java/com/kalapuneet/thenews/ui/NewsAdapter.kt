...
class NewsAdapter (private val articleList: ArrayList<ArticlesItem>, private val retryCallback: () -> Unit): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemCount() = articleList.size + if (hasExtraRow()) 1 else 0
